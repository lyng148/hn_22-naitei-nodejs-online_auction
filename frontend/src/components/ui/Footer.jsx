import { Container, PrimaryButton, ProfileCard, Title } from "./index";
...
export const Footer = () => {
  ...
  return (
    <>
      <footer className=" relative bg-[#204C41] py-16 mt-16">
        ...
        <Container className={`${isHomePage ? "mt-32" : "mt-0"} flex flex-col md:flex-row justify-between gap-12`}>
          <div className="w-full md:w-1/3">
            <img src="../../../public/images/common/header-logo.png" alt="" />
            <br />
            <p className="text-gray-300">Created with the collaboration of over 60 of the worlds best Neuron Artists.</p>
            <div className="bg-gray-300 h-[1px] my-8"></div>
            <Title className=" font-normal text-gray-100">Get The Latest Neuron Updates</Title>
