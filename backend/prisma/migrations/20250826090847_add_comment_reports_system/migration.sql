...
CREATE TABLE `comment_reports` (
    ...
    `report_type` ENUM('INAPPROPRIATE_LANGUAGE', 'SPAM', 'HARASSMENT', 'UNRELATED_CONTENT', 'OTHER') NOT NULL,
    ...
    UNIQUE INDEX `comment_reports_comment_id_reporter_id_key`(`comment_id`, `reporter_id`),
...
-- AddForeignKey
ALTER TABLE `auction_comments` ADD CONSTRAINT `auction_comments_auction_id_fkey` FOREIGN KEY (`auction_id`) REFERENCES `auctions`(`auction_id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `auction_comments` ADD CONSTRAINT `auction_comments_user_id_fkey` FOREIGN KEY (`user_id`) REFERENCES `users`(`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `comment_reports` ADD CONSTRAINT `comment_reports_comment_id_fkey` FOREIGN KEY (`comment_id`) REFERENCES `auction_comments`(`comment_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `comment_reports` ADD CONSTRAINT `comment_reports_reviewer_id_fkey` FOREIGN KEY (`reviewer_id`) REFERENCES `users`(`user_id`) ON DELETE SET NULL ON UPDATE CASCADE;
